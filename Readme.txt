...
После отработки скрипта на экран будет выведен номер RPC-порта, этот номер нужно использовать при создании тунеля PUTTY. Например, если порт равен 9009, то в настройках тунеля указать 9999 localhost:9009
